...
def infer_constraints_for_callable(
    ...
    for i, actuals in enumerate(formal_to_actual):
        if isinstance(callee.arg_types[i], UnpackType):
            ...
            if isinstance(unpack_type.type, TypeVarTupleType):
            ...
            elif isinstance(get_proper_type(unpack_type.type), TupleType):
                ...
                inner_unpack = get_proper_type(unpack_type.type.items[0])
                ...
                suffix_len = len(unpack_type.type.items) - 1
                constraints.append(
                    Constraint(
